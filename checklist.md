...
- [x] Create `encodeWorkbookToDsl(workbook)`
- [x] Validate input before encoding
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Encoder can accept canonical AST safely

---

### 6.2 Encode workbook structure
- [x] Add version/header
- [x] Iterate sheets in deterministic order
- [x] Join sheets using defined separators
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Workbook-level DSL is stable

---

### 6.3 Encode sheets
- [x] Encode sheet metadata
- [x] Encode sheet cells
- [x] Respect sparse representation rules
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Sheet encoding is correct and compact
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Cell encoding is reversible

---

### 6.5 Add determinism tests
- [x] Same AST encodes to same DSL string
- [x] Reordered object keys do not change output unexpectedly
...
### 7.1 Build DSL panel
- [x] Render encoded DSL text
- [x] Make it scrollable
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] User can inspect and reuse DSL easily
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] User can compare formats quickly

---

### 9.2 Highlight outcomes
- [x] Highlight best-performing format
- [x] Highlight DSL savings
- [x] Show summary sentence
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Insights are obvious without manual math
...
- [x] Create `decodeDslToWorkbook(dsl)`
- [x] Handle empty or malformed input
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Decoder accepts DSL safely

---

### 10.2 Parse workbook structure
- [x] Parse header/version
- [x] Split sheet sections
- [x] Validate overall structure
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Decoder understands workbook-level format

---

### 10.3 Parse sheets
- [x] Parse sheet names
- [x] Parse sheet cell blocks
- [x] Rebuild sheet objects
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Sheets reconstruct correctly
...
- [x] Parse type marker
- [x] Parse value
- [x] Unescape reserved characters
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Cells reconstruct to canonical shape

---

### 10.5 Validate reconstructed AST
- [x] Run Zod validation
- [x] Return structured decoder errors when invalid
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Decoder never returns unchecked malformed AST

---

### 10.6 Add decoder tests
- [x] Decode minimal DSL example
- [x] Decode multi-sheet example
- [x] Decode sparse example
- [x] Test malformed DSL cases
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Decoder is test-backed and resilient
...
- [x] Compare workbook sheet count
- [x] Compare sheet names
...
- [x] Compare original AST to decoded AST
- [x] Record mismatches
- [x] Record missing sheets/cells
- [x] Record extra sheets/cells
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Verification produces structured diffs

---

### 11.3 Implement success/failure summary
- [x] Return boolean `success`
- [x] Return array of diffs
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Verification output can power UI directly
...
- [x] Show pass/fail badge
- [x] Show concise summary
- [x] Show mismatch counts
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] User understands round-trip status instantly

---

### 12.2 Build diff viewer
- [x] Show sheet-level diffs
- [x] Show cell-level diffs
- [x] Make diffs readable
...
- [x] Rebuild SheetJS workbook object
- [x] Rebuild sheets from canonical AST
- [x] Reinsert cell values into correct addresses
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] AST can be transformed into exportable workbook data

---

### 13.2 Generate downloadable XLSX
- [x] Serialize workbook to file
- [x] Trigger download in browser
- [x] Name output file predictably
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] User can download reconstructed `.xlsx`
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Export works in real spreadsheet software
...
- [x] Define `runPipeline(file)`
- [x] Define returned result shape
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] All pipeline stages can be run through one entrypoint
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Single function can execute full pipeline
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Pipeline fails safely and visibly
...
- [x] AST state
- [x] DSL state
- [x] Token report state
- [x] Decoded AST state
- [x] Verification state
- [x] Error/loading state
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] UI has a single coherent state shape

---

### 15.2 Wire state into app
- [x] Store pipeline results centrally
- [x] Feed views from state
- [x] Reset state on new upload when needed
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] App updates consistently after each upload
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] Core scenarios are represented in tests

---

### 17.2 Add round-trip tests
- [x] parse → encode → decode → verify
- [x] confirm success for supported scenarios
...
- [x] **Types:** `pnpm exec tsc --noEmit` passes (or `pnpm build` if that is the project typecheck)
- [x] **Tests:** Add or update automated tests for new/changed behavior; `pnpm test` passes
- [x] End-to-end behavior is protected

---

### 17.3 Add edge-case tests
- [x] empty workbook-like scenarios
- [x] blank cells
- [x] long strings
- [x] reserved character escaping
